...
public class Jogador{
    ...
    public int energia = 100;        //int e bool sao propriedades || variaveis;
    bool vivo = true;
...
class Aula28
{
    ...
    Console.WriteLine("Energia do jogaador 1: {0}",j1.energia);
    Console.WriteLine("Energia do jogaador 1: {0}",j2.energia);
    }
